 ...
 *
 * Title:             Archive-Resource-Grid
 * Description:       Archive of resource posts.
 * Category:          Archive
 * Icon:              archive
 * Keywords:          resource, archive, posts, grid, 829 filters
 * Post Types:        all
 * Multiple:          false
 * Active:            true
 * CSS Deps:          resource-card, pagination, filter-checkbox
 * JS Deps:
 * Global ACF Fields:
 * InnerBlocks:       false
 * Mode:              preview
...
if ( 'resource_type' === $this_taxonomy ) {
	$display_sidebar = true;
}

?>

<section <?php echo wp_kses_post( $content_block->get_block_id_attr() ); ?>class="acf-block block-archive-resource-grid<?php echo esc_attr( $content_block->get_block_classes() ); ?>">
	<div class="container">
		<?php if ( is_admin() ) : ?>
			<div class="has-t-3-font-size bg-black"><?php esc_html_e( 'Resource posts will be displayed here.', 'propel' ); ?></div>
